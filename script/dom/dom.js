...
var TestDOMElement = (
	function()
	{
		...
		TestingManager.addTest("TestDOMElementAddClass",TestAddClass,"test");
		TestingManager.addTest("TestDOMElementRemoveClass",TestRemoveClass,undefined);
		TestingManager.addTest("TestDOMElementToggleClass",TestToggleClass,"test2");
